...
variable "proxmox_ssh_host" {
  description = "SSH-accessible host for a Proxmox cluster node. Defaults to the host parsed from proxmox_endpoint. pct commands are cluster-aware, so any node works."
  type        = string
  default     = null
}
